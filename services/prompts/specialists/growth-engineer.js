...
module.exports = buildSpecialistModule({
  ...
  preferred_methodologies: ['cialdini-7', 'hormozi-value-equation', 'ariely-irrationality', 'kahneman-system-1-2'],
  preferred_channels: ['push-notification', 'email-promo', 'sms', 'instagram-post', 'x-post'],
  decision_style:
