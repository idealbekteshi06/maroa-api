...
const CURRENCY_TABLE = {
  ...
  VND: { symbol: '₫', to_usd: 0.00004, decimals: 0 },
  ...
  EGP: { symbol: '£', to_usd: 0.02, decimals: 2 },
...
function buildMarketProfile(business, opts = {}) {
  ...
  const primaryLang = String(business?.primary_language || defaults?.langs?.[0] || 'en')
    .toLowerCase()
    .slice(0, 2);
