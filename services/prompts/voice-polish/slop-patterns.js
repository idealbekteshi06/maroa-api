...
const SLOP_PATTERNS = [
  ...
  { id: 'AI001', language: 'en', pattern: /\bit'?s\s+worth\s+noting\s+that\b/i, penalty: 9, category: 'opener' },
  {
    id: 'AI002',
    language: 'en',
    pattern: /\bin\s+today'?s\s+(?:fast.?paced|digital|modern|competitive)\s+(?:world|landscape|environment)\b/i,
    penalty: 10,
    category: 'opener',
  },
  {
    id: 'AI003',
    language: 'en',
    pattern: /\b(?:let'?s\s+)?dive\s+(?:right\s+)?(?:in)?(?:to)\b/i,
    penalty: 8,
    category: 'transition',
  },
  ...
  { id: 'AI005', language: 'en', pattern: /\b(?:elevate|elevating)\s+your\b/i, penalty: 9, category: 'buzzword' },
  {
    id: 'AI006',
    language: 'en',
    pattern: /\b(?:navigate|navigating)\s+(?:the\s+)?complexities\b/i,
    penalty: 9,
    category: 'cliche',
  },
  ...
  { id: 'AI018', language: 'en', pattern: /\b(?:streamline|streamlining)\b/i, penalty: 5, category: 'buzzword' },
  {
    id: 'AI019',
    language: 'en',
    pattern: /\bend.?to.?end\s+(?:solution|experience)\b/i,
    penalty: 7,
    category: 'cliche',
  },
  { id: 'AI020', language: 'en', pattern: /\b(?:furthermore|moreover)\b/i, penalty: 6, category: 'transition' },
  {
    id: 'AI021',
    language: 'en',
    pattern: /\b(?:in\s+conclusion|to\s+conclude|to\s+sum\s+up)\b/i,
    penalty: 7,
    category: 'transition',
  },
  {
    id: 'AI022',
    language: 'en',
    pattern: /\b(?:I\s+understand|I\s+can\s+see)\s+(?:that|how)\s+you\b/i,
    penalty: 8,
    category: 'hedge',
  },
  {
    id: 'AI023',
    language: 'en',
    pattern: /\b(?:certainly|absolutely|definitely)!?(?:\s+|$)/i,
    penalty: 5,
    category: 'hedge',
  },
  ...
  { id: 'AI026', language: 'en', pattern: /\bplethora\s+of\b/i, penalty: 8, category: 'filler' },
  {
    id: 'AI027',
    language: 'en',
    pattern: /\bunlock\s+(?:the\s+)?(?:power|potential)\b/i,
    penalty: 8,
    category: 'cliche',
  },
  {
    id: 'AI028',
    language: 'en',
    pattern: /\btake\s+(?:your|it)\s+to\s+the\s+next\s+level\b/i,
    penalty: 9,
    category: 'cliche',
  },
  {
    id: 'AI029',
    language: 'en',
    pattern: /\b(?:embark|embarking)\s+on\s+(?:a|this)\s+journey\b/i,
    penalty: 9,
    category: 'cliche',
  },
  ...
  { id: 'AI032', language: 'en', pattern: /\bnext.?gen(?:eration)?\b/i, penalty: 5, category: 'buzzword' },
  {
    id: 'AI033',
    language: 'en',
    pattern: /\b(?:from\s+small\s+businesses\s+to\s+enterprises|whether\s+you'?re\s+a)\b/i,
    penalty: 7,
    category: 'cliche',
  },
  { id: 'AI034', language: 'en', pattern: /\bharness(?:ing)?\s+the\s+power\b/i, penalty: 8, category: 'cliche' },
  {
    id: 'AI035',
    language: 'en',
    pattern: /\bpower\s+of\s+(?:AI|technology|automation)\b/i,
    penalty: 6,
    category: 'cliche',
  },
  ...
  // ─── SPANISH ───────────────────────────────────────────────────────────
  {
    id: 'AI071',
    language: 'es',
    pattern: /\ben\s+el\s+mundo\s+(?:actual|de\s+hoy)\b/i,
    penalty: 10,
    category: 'opener',
  },
  { id: 'AI072', language: 'es', pattern: /\bsumérgete\s+en\b/i, penalty: 9, category: 'transition' },
  {
    id: 'AI073',
    language: 'es',
    pattern: /\bllevar?\s+(?:tu|su)\s+\w+\s+al\s+(?:siguiente|próximo)\s+nivel\b/i,
    penalty: 9,
    category: 'cliche',
  },
  ...
  // ─── FRENCH ────────────────────────────────────────────────────────────
  {
    id: 'AI091',
    language: 'fr',
    pattern: /\bdans\s+le\s+monde\s+(?:actuel|d'?aujourd'?hui)\b/i,
    penalty: 10,
    category: 'opener',
  },
  { id: 'AI092', language: 'fr', pattern: /\bplongez\s+(?:dans|au\s+coeur)\b/i, penalty: 9, category: 'transition' },
  {
    id: 'AI093',
    language: 'fr',
    pattern: /\bportez\s+(?:votre|vos)\s+\w+\s+au\s+niveau\s+supérieur\b/i,
    penalty: 9,
    category: 'cliche',
  },
  {
    id: 'AI094',
    language: 'fr',
    pattern: /\bsolutions?\s+(?:innovantes?|de\s+pointe)\b/i,
    penalty: 7,
    category: 'buzzword',
  },
  ...
  // ─── GERMAN ────────────────────────────────────────────────────────────
  {
    id: 'AI111',
    language: 'de',
    pattern: /\bin\s+der\s+heutigen\s+(?:digitalen|schnelllebigen)\s+welt\b/i,
    penalty: 10,
    category: 'opener',
  },
  {
    id: 'AI112',
    language: 'de',
    pattern: /\b(?:tauchen\s+sie\s+ein|eintauchen\s+in)\b/i,
    penalty: 9,
    category: 'transition',
  },
  {
    id: 'AI113',
    language: 'de',
    pattern: /\bauf\s+das\s+nächste\s+(?:level|niveau)\b/i,
    penalty: 9,
    category: 'cliche',
  },
  ...
  { id: 'AI132', language: 'it', pattern: /\bimmergiti\s+(?:nel|nella)\b/i, penalty: 9, category: 'transition' },
  {
    id: 'AI133',
    language: 'it',
    pattern: /\b(?:porta|portare)\s+(?:il\s+tuo|i\s+tuoi)\s+\w+\s+al\s+livello\s+successivo\b/i,
    penalty: 9,
    category: 'cliche',
  },
  {
    id: 'AI134',
    language: 'it',
    pattern: /\bsoluzion[ei]\s+(?:innovative?|all'avanguardia)\b/i,
    penalty: 7,
    category: 'buzzword',
  },
  ...
  { id: 'AI152', language: 'pt', pattern: /\bmergulhe\s+(?:no|na)\b/i, penalty: 9, category: 'transition' },
  {
    id: 'AI153',
    language: 'pt',
    pattern: /\b(?:leve|levar)\s+(?:o\s+seu|a\s+sua)\s+\w+\s+(?:ao|para)\s+(?:próximo|outro)\s+nível\b/i,
    penalty: 9,
    category: 'cliche',
  },
  {
    id: 'AI154',
    language: 'pt',
    pattern: /\bsoluç[õo]es?\s+(?:inovadora?s?|de\s+ponta)\b/i,
    penalty: 7,
    category: 'buzzword',
  },
  ...
  // ─── DUTCH ──────────────────────────────────────────────────────────────
  {
    id: 'AI171',
    language: 'nl',
    pattern: /\bin\s+de\s+(?:huidige|hedendaagse)\s+wereld\b/i,
    penalty: 10,
    category: 'opener',
  },
  ...
  // ─── TURKISH ────────────────────────────────────────────────────────────
  {
    id: 'AI191',
    language: 'tr',
    pattern: /\bgünümüzün\s+(?:hızlı|dijital|rekabetçi)\s+dünyasında\b/i,
    penalty: 10,
    category: 'opener',
  },
  ...
  // ─── SERBIAN / CROATIAN ────────────────────────────────────────────────
  {
    id: 'AI211',
    language: 'sr',
    pattern: /\bu\s+današnjem\s+(?:digitalnom|brzom)\s+svetu\b/i,
    penalty: 10,
    category: 'opener',
  },
  {
    id: 'AI212',
    language: 'hr',
    pattern: /\bu\s+današnjem\s+(?:digitalnom|brzom)\s+svijetu\b/i,
    penalty: 10,
    category: 'opener',
  },
  ...
  { id: 'AI301', language: 'any', pattern: /\bAs\s+an\s+AI\b/i, penalty: 10, category: 'meta' },
  {
    id: 'AI302',
    language: 'any',
    pattern: /\b(?:I\s+hope\s+this\s+helps|hope\s+this\s+helps)\b/i,
    penalty: 6,
    category: 'meta',
  },
  {
    id: 'AI303',
    language: 'any',
    pattern: /\b(?:please\s+let\s+me\s+know|feel\s+free\s+to\s+ask)\b/i,
    penalty: 6,
    category: 'meta',
  },
];
