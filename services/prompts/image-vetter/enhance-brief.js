...
const FIX_LANGUAGE = {
  ...
  composition:
    're-stage to rule of thirds with subject placed intentionally; clear background of distractions; add copy-safe negative space',
  lighting:
    'single named source from a stated direction, soft diffused, motivated; remove all secondary sources; warm neutral 5500K unless brand specifies otherwise',
