...
these to understand _why_ something is the way it is — the code answers
_what_ and _how_; ADRs answer _why_.
...
| [0004](./0004-security-fixes-from-antigravity-review.md) | Security fixes from the 2026-05-11 Antigravity adversarial review (6 critical bugs closed, 3 tradeoffs documented) | 2026-05-11 | Accepted |
...
- A decision has consequences that aren't obvious from reading the code
  (e.g. "we chose X _because_ Supabase doesn't let us do Y").
