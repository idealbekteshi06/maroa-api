 ...
 * carve-up). 4 endpoints around Google Ads campaign create + activate +
 * optimize + read:
 *
 ...
 *
 * Internal helpers (gCid, googleAdsReq) moved in from server.js since
 * they're only used by this domain.
 *
