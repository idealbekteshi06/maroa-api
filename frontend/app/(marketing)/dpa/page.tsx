  ...
  return (
    <section className="container pt-20 sm:pt-28 pb-32">
      <div className="container-prose">
        ...
        <h1 className="text-display-lg text-ink-700 mb-6">Data Processing Agreement</h1>
        ...
        <div className="prose prose-lg max-w-none text-ink-700 leading-relaxed space-y-6">
          ...
          <h2 className="text-2xl font-semibold text-ink-700 mt-12 mb-4">Quick links</h2>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 mt-12 mb-4">Key terms (summary)</h2>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 mt-12 mb-4">How to execute the DPA</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 mt-12 mb-4">Contact</h2>
          <p>
