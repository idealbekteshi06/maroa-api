  ...
  return (
    <section className="container pt-20 sm:pt-28 pb-32">
      <div className="container-prose">
        ...
        <h1 className="text-display-lg text-ink-700 dark:text-ink-50 mb-3">Privacy Policy</h1>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-ink-700 dark:text-ink-200 leading-relaxed space-y-6">
          ...
          <h2 className="text-2xl font-semibold text-ink-700 dark:text-ink-50 mt-12 mb-4">1. What we collect</h2>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 dark:text-ink-50 mt-12 mb-4">2. How we use it</h2>
          <ul className="space-y-2 list-disc pl-6">
          ...
          <h2 className="text-2xl font-semibold text-ink-700 dark:text-ink-50 mt-12 mb-4">3. Sub-processors</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 dark:text-ink-50 mt-12 mb-4">4. Where your data lives</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 dark:text-ink-50 mt-12 mb-4">5. Your rights (GDPR + CCPA)</h2>
          <ul className="space-y-2 list-disc pl-6">
          ...
          <h2 className="text-2xl font-semibold text-ink-700 dark:text-ink-50 mt-12 mb-4">6. Cookies</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 dark:text-ink-50 mt-12 mb-4">7. Children</h2>
          <p>Maroa is not intended for users under 16. We do not knowingly collect data from minors.</p>

          <h2 className="text-2xl font-semibold text-ink-700 dark:text-ink-50 mt-12 mb-4">8. Security</h2>
          <ul className="space-y-2 list-disc pl-6">
          ...
          <h2 className="text-2xl font-semibold text-ink-700 dark:text-ink-50 mt-12 mb-4">9. Changes to this policy</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 dark:text-ink-50 mt-12 mb-4">10. Contact</h2>
          <p>
