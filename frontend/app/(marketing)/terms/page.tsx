  ...
  return (
    <section className="container pt-20 sm:pt-28 pb-32">
      <div className="container-prose">
        ...
        <h1 className="text-display-lg text-ink-700 mb-3">Terms of Service</h1>
        ...
        <div className="prose prose-lg max-w-none text-ink-700 leading-relaxed space-y-6">
          ...
          <h2 className="text-2xl font-semibold text-ink-700 mt-12 mb-4">1. The service</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 mt-12 mb-4">2. Your account</h2>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 mt-12 mb-4">3. Acceptable use</h2>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 mt-12 mb-4">4. Compliance gates</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 mt-12 mb-4">5. Pricing + billing</h2>
          <ul className="space-y-2 list-disc pl-6">
          ...
          <h2 className="text-2xl font-semibold text-ink-700 mt-12 mb-4">6. Your content + IP</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 mt-12 mb-4">7. AI-generated content</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 mt-12 mb-4">8. Availability + service levels</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 mt-12 mb-4">9. Termination</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 mt-12 mb-4">10. Disclaimers + liability</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 mt-12 mb-4">11. Governing law</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 mt-12 mb-4">12. Changes</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-ink-700 mt-12 mb-4">13. Contact</h2>
          <p>
