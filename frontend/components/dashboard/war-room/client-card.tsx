...
export function ClientCard({ client }: { client: ClientFeed }) {
  ...
  return (
    <Link
      ...
      className="block rounded-2xl bg-white dark:bg-ink-900 border border-ink-200/60 dark:border-ink-700/60 hover:border-ink-300 dark:hover:border-ink-600 transition-colors p-5"
    >
