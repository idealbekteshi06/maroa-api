...
module.exports = [
  ...
  },
  {
    ...
    suggestion: 'Use only if you can quote the cupping score: "85 SCA-scored Ethiopia Yirgacheffe."',
  },
  {
  ...
  // ─── Info ───────────────────────────────────────────────────────────
  {
    ...
    severity: 'info',
    pattern: /(?:☕|🥐|🍰){3,}/,
    message: 'Café-emoji clusters (☕☕☕, 🥐🥐🥐) reduce Meta delivery by 5-10%. Single, well-placed emoji is fine.',
