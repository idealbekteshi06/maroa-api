...
class CircuitBreaker {
  ...
  async fire(fn) {
    ...
    // Half-open: admit only ONE probe at a time; concurrent callers fast-fail.
    // Without this, every request arriving when the cooldown expires hit the
    // still-fragile upstream simultaneously (thundering herd) and could
