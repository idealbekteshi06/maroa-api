...
| Cron                      | **Inngest (production).** Durable schedules in `services/inngest/functions.js` + curated `ops-maintenance` fan-outs. Legacy `n8n-workflows/` is archive-only. See `docs/INNGEST_ORCHESTRATION.md`.                                                                                              |
